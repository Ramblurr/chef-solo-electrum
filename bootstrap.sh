...
mkdir -p /var/chef/site-cookbooks /var/chef/cookbooks /var/chef/roles /var/chef/data_bags /etc/chef
touch /etc/chef/solo.rb

# Copy cookbooks from /tmp
#
cp -r /tmp/cookbooks/* /var/chef/cookbooks
cp -r /tmp/roles/* /var/chef/roles
cp -r /tmp/data_bags/* /var/chef/data_bags
